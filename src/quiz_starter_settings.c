    ...
    switch (state) {
        case 0x42:; // Compute Starter List.
            ...
            if (newApSettings.nums.starterOptions == STARTER_OPTION_OVERRIDE) {
                ...
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[1]) << 1);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[2]) << 2);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[3]) << 3);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[4]) << 4);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[5]) << 5);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[6]) << 6);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[7]) << 7);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[8]) << 8);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[9]) << 9);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[10]) << 10);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[11]) << 11);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[12]) << 12);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[13]) << 13);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[14]) << 14);
                randomizedHeroNum ^= (((uint32_t)slotData.apSlotName[15]) << 15);
